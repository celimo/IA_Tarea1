...
datos_train = pd.read_csv('datos/train_ruido.csv', header=0)        # Entrenamiento
datos_test = pd.read_csv('datos/test_ruido.csv', header=0)          # Validacion
...
model = keras.Sequential([
    ...
    keras.layers.Dense(2, activation='sigmoid'),  # hidden layers
