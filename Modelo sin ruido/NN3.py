...
prob_matrix = model.predict(datos_cte03)
pred_labels = np.argmax(prob_matrix, axis=-1)
print(prob_matrix)
print(pred_labels)
for i in range(len(pred_labels)):
    if pred_labels[i] == 0:
        class_0x.append(datos_cte03['SD_left'][i])
        class_0y.append(datos_cte03['SD_right'][i])
        class_0z.append(datos_cte03['SD_back'][i])
    if pred_labels[i] == 1:
        class_1x.append(datos_cte03['SD_left'][i])
        class_1y.append(datos_cte03['SD_right'][i])
        class_1z.append(datos_cte03['SD_back'][i])
    if pred_labels[i] == 2:
        class_2x.append(datos_cte03['SD_left'][i])
        class_2y.append(datos_cte03['SD_right'][i])
        class_2z.append(datos_cte03['SD_back'][i])
    if pred_labels[i] == 3:
        class_3x.append(datos_cte03['SD_left'][i])
        class_3y.append(datos_cte03['SD_right'][i])
        class_3z.append(datos_cte03['SD_back'][i])
...
ax1.scatter(class_2x, class_2y, class_2z, c='r', marker='o')
ax1.scatter(class_3x, class_3y, class_3z, c='y', marker='o')
plt.savefig("regiones/regSD_F03.png")
plt.show()

# Con una constante de 0,6
...
prob_matrix = model.predict(datos_cte06)
pred_labels = np.argmax(prob_matrix, axis=-1)
print(prob_matrix)
print(pred_labels)
for i in range(len(pred_labels)):
    if pred_labels[i] == 0:
        class_0x.append(datos_cte06['SD_left'][i])
        class_0y.append(datos_cte06['SD_right'][i])
        class_0z.append(datos_cte06['SD_back'][i])
    if pred_labels[i] == 1:
        class_1x.append(datos_cte06['SD_left'][i])
        class_1y.append(datos_cte06['SD_right'][i])
        class_1z.append(datos_cte06['SD_back'][i])
    if pred_labels[i] == 2:
        class_2x.append(datos_cte06['SD_left'][i])
        class_2y.append(datos_cte06['SD_right'][i])
        class_2z.append(datos_cte06['SD_back'][i])
    if pred_labels[i] == 3:
        class_3x.append(datos_cte06['SD_left'][i])
        class_3y.append(datos_cte06['SD_right'][i])
        class_3z.append(datos_cte06['SD_back'][i])
...
ax1.scatter(class_2x, class_2y, class_2z, c='r', marker='o')
ax1.scatter(class_3x, class_3y, class_3z, c='y', marker='o')
plt.savefig("regiones/regSD_F06.png")
plt.show()

# Con una constante de 1
...
prob_matrix = model.predict(datos_cte1)
pred_labels = np.argmax(prob_matrix, axis=-1)
print(prob_matrix)
print(pred_labels)
...
for i in range(len(pred_labels)):
    if pred_labels[i] == 0:
        class_0x.append(datos_cte1['SD_left'][i])
        class_0y.append(datos_cte1['SD_right'][i])
        class_0z.append(datos_cte1['SD_back'][i])
    if pred_labels[i] == 1:
        class_1x.append(datos_cte1['SD_left'][i])
        class_1y.append(datos_cte1['SD_right'][i])
        class_1z.append(datos_cte1['SD_back'][i])
    if pred_labels[i] == 2:
        class_2x.append(datos_cte1['SD_left'][i])
        class_2y.append(datos_cte1['SD_right'][i])
        class_2z.append(datos_cte1['SD_back'][i])
    if pred_labels[i] == 3:
        class_3x.append(datos_cte1['SD_left'][i])
        class_3y.append(datos_cte1['SD_right'][i])
        class_3z.append(datos_cte1['SD_back'][i])
...
ax1.scatter(class_2x, class_2y, class_2z, c='r', marker='o')
ax1.scatter(class_3x, class_3y, class_3z, c='y', marker='o')
plt.savefig("regiones/regSD_F1.png")
plt.show()
"""
