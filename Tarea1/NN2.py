        ...
        for l in range(3):
            for m in range(3):
                ...
                model = keras.Sequential([
                    ...
                    keras.layers.Dense(numNeu[j], activation='sigmoid'),  # hidden layers
                ...
                iteration = canIter[m]  # Cantidad de iteraciones para el entrenamiento
                ...
                model.save(dirM)  # Se guarda con una extensión h.5
